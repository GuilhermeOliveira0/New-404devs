...
const html = `<!doctype html><html lang="pt-BR"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#ffffff"><meta name="description" content="Sites, aplicativos e sistemas sob medida para simplificar o seu negócio."><title>404Devs — Da ideia ao sistema.</title><link rel="icon" href="assets/favicon-32.png" sizes="32x32" type="image/png"><link rel="icon" href="assets/favicon-192.png" sizes="192x192" type="image/png"><link rel="apple-touch-icon" href="assets/apple-touch-icon.png"><link rel="preload" href="assets/fonts/bricolage-grotesque-700.woff2" as="font" type="font/woff2" crossorigin><link rel="stylesheet" href="style.css?v=8"><script src="script.js?v=8" defer></script></head><body>
<a href="#principal" class="skip">Pular para conteúdo</a><div class="scroll-progress" aria-hidden="true"></div>
<header><a href="#" class="brand" aria-label="404Devs, início"><img src="assets/brand/logo.webp" alt="404Devs" width="640" height="147" decoding="async"></a><nav aria-label="Principal"><a href="#projetos">${roll('Projetos')}</a><a href="#sobre">${roll('Estúdio')}</a><a href="#processo">${roll('Como trabalhamos')}</a><a href="#avaliacoes">${roll('Avaliações')}</a><a href="#duvidas">${roll('Dúvidas')}</a><a href="#contato">${roll('Vamos conversar ↗')}</a></nav></header>
